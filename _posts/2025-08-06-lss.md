...
<img width="290" height="204" alt="image" src="https://github.com/user-attachments/assets/2b9fc0b9-e096-4676-b99c-f3886bcce195" />
...
벡터공간 R4에서 선형방정식 x+2y+3z+4w=0의 해공간(solution space)을 W라고 하자. 선형변환 T:R4→R4가 W로의 직교사영(orthogonal projection)일 때 T의 표준행렬(Standard matrix)의 모든 성분(entry)의 합은? <br>
