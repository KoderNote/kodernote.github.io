...
<img width="928" height="646" alt="image" src="https://github.com/user-attachments/assets/5ef14c8e-c551-4df4-a6aa-0ecdcbd8a02b" />
...
<img width="778" height="461" alt="image" src="https://github.com/user-attachments/assets/551acbdb-ba2b-4541-9cb3-5f84ac3ab450" />
<br>
...
V의 부분집합 ${v_1, v_2, \ldots, v_n}$이 **V를 생성(span)한다**는 것은 V의 모든 벡터 v가 v1​,…,vn​의 일차결합으로 표현될 수 있다는 것을 의미한다. 즉, v=a1​v1​+a2​v2​+⋯+an​vn​이 성립하는 실수 a1​,…,an​이 존재한다.
